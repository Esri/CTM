...
class Toolbox(object):
    ...
    def __init__(self):
        ...
        self.label = "Fixed 50K Tools"
        self.alias = "fixed50kTools"
...
class MapGenerator(object):
    ...
    def getParameterInfo(self):
        ...
        product_as_json.value = '{"productName":"Fixed 50K","makeMapScript":"Fixed50K_MapGenerator.pyt","toolName":"MapGenerator","mxd":"CTM50KTemplate.mxd","gridXml":"CTM_UTM_WGS84_grid.xml","pageMargin":"4.5 8 23 8 CENTIMETERS","exporter":"PDF","exportOption":"Export","geometry":{"rings":[[[-12439954.397695806,4920587.7140160939],[-12453869.336493993,4920587.7125548637],[-12453869.337941146,4938870.05400884],[-12453869.339388302,4957186.4929140275],[-12439954.400590109,4957186.4943807106],[-12426039.461903244,4957186.4958474],[-12426039.460344769,4938870.0569367381],[-12426039.458897619,4920587.7153311959],[-12439954.397695806,4920587.7140160939]]],"spatialReference":{"wkid":102100,"latestWkid":3857}},"angle":0,"pageSize":"CUSTOM PORTRAIT 63 88 CENTIMETERS","quad_id":403011145,"mapSheetName":"Draper 50K Demo","customName":""}'
                ...
                if product.quad_id == "":
                    ...
                    for l in layers:
                        if l.name == "Index_AOI":
                            ...
                            adjoining_data_frame.scale = 940000
